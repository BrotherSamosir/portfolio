  ...
  return (
    ...
    <div  className={styles.container_image}>  
      ...
      <div className={styles.link_buttons}>
        ...
        <a href='#' target={'_blank'} className={styles.button} style={{cursor:'pointer'}}>Download Resume</a>
              ...
              <div className="border-0 rounded-2xl shadow-lg relative flex flex-col w-full lg:h-[600px] bg-white outline-none focus:outline-none">
                ...
                />
                  ...
                  <span className='flex flex-row justify-center'>
                     ...
                     <a id='facebook' href='https://web.facebook.com/alders.samosir.1/' target={'_blank'} className='cursor-pointer	ml-10 '>
                     ...
                     <a id='instagram' href='https://www.instagram.com/alders_antonius_samosir/' target={'_blank'} className='cursor-pointer	ml-3'>
